"""
Django settings for sampleseveralrequir_46718 project.
...
ROOT_URLCONF = 'sampleseveralrequir_46718.urls'
...
WSGI_APPLICATION = 'sampleseveralrequir_46718.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sampleseveralrequir_46718 API",
    "DESCRIPTION": "API documentation for sampleseveralrequir_46718 App",
    "VERSION": "v1",
}
